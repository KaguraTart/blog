...
3. Khattab, O., & Potts, C. (2021). *Representing Documents via Maximal Marginal Relevance.* arXiv.
4. Ram, O., et al. (2023). *In-Context Retrieval-Augmented Language Model.* TACL.
5. Hoshi, Y., et al. (2023). *RuLES: Multi-document QA with Retrieval-Augmented LM.* ACL.
...
8. Biderman, D., et al. (2024). *Microsoft Phi-3: A Highly Capable Language Model.* Microsoft Research.
9. Ouyang, L., et al. (2022). *Training language models to follow instructions with human feedback.* NeurIPS.
10. Rafailov, R., et al. (2023). *Direct Preference Optimization: Your Language Model is Secretly a Reward Model.* NeurIPS.
11. Meng, Y., et al. (2024). *Fine-tuning Large Language Models.* arXiv.
12. Wang, Y., et al. (2024). *LLaMA-Factory: Unified Efficient Fine-Tuning of 100+ LLMs.* arXiv.

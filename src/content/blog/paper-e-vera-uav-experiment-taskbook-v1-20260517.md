...
description: "v2 聚焦 AAAI 顶会投稿：补充 30+ 篇真实可引用定会/顶刊/关键预印本文献，深化 VERA-UAV 的实验指标、对比与消融方案，并给出相对完备性的数学证明。"
pubDate: 2026-05-17
...
> 本文件仍沿用 `paper-e-vera-uav-experiment-taskbook-v1-20260517.md` 文件名，是因为本轮要求“直接在 V1 版本上修改”。正文、标题与版本说明均已升级为 **v2**。本文不是最终论文草稿，而是可执行的实验任务书：明确 Paper E 的研究定位、真实可引用文献、算法方案、数据构建、对比实验、消融实验、评价指标、理论完备性边界与后续 AAAI/T-ITS 推进计划。
...
截至 2026-05-17，尚未检索到 AAAI-27 Main Technical Track 官方 CFP；当前倒排参考 AAAI-26 的官方提交节奏与页面限制 [38]。
...
**版本说明：** 本文内容已更新为 `v2`，但文件名沿用 `v1-20260517` 以满足本轮“直接在 V1 版本上修改”的要求。下一版建议在完成数据集 schema 和第一轮 baseline 跑通后更新为 `v3-YYYYMMDD`，重点替换 `TBD` 表格、补充真实实验结果和失败案例。
